...
<article class="widget">
							<header class="widget__header">
								<div class="widget__title" style="width:100%;">
									<i class="pe-7f-network"></i><h3><?php echo htmlentities($row['name']); ?></h3>
								</div>
							</header>
								...
								<div class="row">
									<div class="col-md-12 text-center btn__showcase2">
										<?php
											...
											echo "Costs $" . $row['price'] . " USD, for a maximum of " . $row['mbt'] . " seconds for attacks, " . $row['max_boots'] . " concurrents lasting " . $row['length'] . " " . $row['unit'] . ".</strong>";
										?>
<center>
									<a href="order.php?id=<?php echo $row['ID']; ?>&method=paypal" title="" class="btn blue inverse">Paypal</a>
									<a href="order.php?id=<?php echo $row['ID']; ?>&method=bitcoin" title="" modal-type="btc" class="btn orange iframePopup inverse">Bitcoin</a>
									<a href="order.php?id=<?php echo $row['ID']; ?>&method=stripe" title="" modal-type="cc" class="btn violet iframePopup inverse">Credit Card</a></center>
									</div>
