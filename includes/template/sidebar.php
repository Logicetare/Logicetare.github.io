...
?>
			...
			<div class="user-info">
				...
				<ul class="main-nav">
					...
					<li<?php echo ($currentPage === "account" ? ' class="main-nav--active"' : ''); ?>>
						<a class="main-nav__link" href="profile.php">
							<span class="main-nav__icon"><i class="pe-7f-user"></i></span>
							Your Account
						</a>
					</li>
					<li<?php echo ($currentPage === "news" ? ' class="main-nav--active"' : ''); ?>>
						<a class="main-nav__link" href="news.php">
...
?>
					<li<?php echo ($currentPage === "booter" ? ' class="main-nav--active"' : ''); ?>>
						<a class="main-nav__link" href="booter.php">
					...
					<li class="main-nav--collapsible<?php echo ($currentPage === "tools" ? ' main-nav--active' : ''); ?>">
						<a class="main-nav__link" href="#" onclick="return false;">
							...
							Tools <span class="badge badge--line badge--blue">4</span>
						</a>
						<ul class="main-nav__submenu">
							<li><a href="resolver.php"><span>Resolvers</span></a></li>
							<li><a href="iplogger.php"><span>IP Logger</span></a></li>
							<li><a href="isitup.php"><span>Website Status Checker</span></a></li>
							<li><a href="portscan.php"><span>Port Scan</span></a></li>
						</ul>
					</li>
<?php } ?>
			...
			<div class="user-info"><br /><br />
				...
				<ul class="main-nav">
					...
					<li<?php echo ($currentPage === "admin_servers" ? ' class="main-nav--active"' : ''); ?>>
						<a class="main-nav__link" href="servers.php">
